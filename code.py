...
mean_value =  agg_values_ina_month(weather,'Date/Time','Temp (C)',{'Temp (C)':np.mean})
...
temp_converted = convert(weather,'Temp (C)')
print(temp_converted.head())
